/***********************************************************
[strategy pettern]
- 행동(알고리즘)을 객체로 캡슐화해서 런타임에 변경할수 있도록하는 디자인 패턴
- 어떤 기능을 수행하는 여러가지 방법이 있을때 해당 기능을 직접 구현하는게 아니라 전략객체를 만들어서 교체
...
namespace _20250417
{
    class Monster
    {
        ...
        public void Attack()
        {
            ...
            {
                Console.WriteLine($"{name}이 강력한 마법공격한다");
            }
        }
    }
    ...
    class MagicAttack : IAttackStrategy
    {
        public void Attack(string name)
        {
            Console.WriteLine($"{name}이 강력한 마법 공격한다");
        }
    }
    class Monster1
    {

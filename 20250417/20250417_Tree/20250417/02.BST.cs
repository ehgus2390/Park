...
<이진 탐색 트리 탐색>
 ...
 - 작은 경우 왼쪽자식노드로, 큰 경우 오른쪽 자식 노드를 탐색
             23(↙)
      ┌──────┴──────┐
      11↘          38
   ┌──┴──┐       ┌──┴──┐
...
2. 자식 2개인 노드의 삭제: 만약 38을 삭제하려면?
  -  삭제하는 노드를 기준으로 오른쪽 자식중 가장 작은 값 노드와 교체 후 삭제
...
namespace _20250417
{
    internal class CBST
    {
        ...
        public class BinarySearchTree<T> where T:IComparable<T>
        {
            ...
            private Node root;      //트리의 루트노드(가장 상위 노드)
            ...
            public bool Add(T item)
            {
                ...
                Node current = root;// 현재 위치를 루트에서 시작
